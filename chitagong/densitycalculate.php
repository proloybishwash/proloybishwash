    ...
    <div id="wrap">
       ...
       <!--PAGE CONTENT -->
        <div id="content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">DENSITY Calculation ALL IN ONE
                    </h1>
                </div>
            </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="box">
            <header>
                <h5><i class="icon-th-large"></i> ALL PLANET DENSITY Calculation</h5>
            </header>
            <div class="row">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN EARTH</label>
                            <div class="col-lg-4">
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN MERCURY</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN VENUS</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN THE MOON</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN MARS</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN JUPITER</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN SATURN</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN URANUS</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN NEPTUNE</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
               ...
               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <form action="" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-lg-8">Density IN PLUTO</label>
                            <div class="col-lg-4">
                                <input type="text" id="digits" name="digits" class="form-control" 
